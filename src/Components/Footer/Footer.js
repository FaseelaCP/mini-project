    ...
    <div className="footer mt-5 pt-4">
      <div className=" row  border-bottom border-light">
       ...
       <h5 className="mb-3">Top Categories</h5>
            ...
            {categoryParams?.categories?.data?.map((c) => (
              <Link  to={'/category/'+c.name}> <h6 className="mb-3" key={c.id}><a>{c.name}</a></h6></Link>
            ))}
          
        </div>
        <div className="col-3">
          <Link to='/aboutus'><h5 className="mb-3">About Us</h5></Link>
        ...
        <div className="col-3">
        <Link to='/contactus'><h5 className="mb-3">Contact Us</h5></Link>
        <h6 className="mb-3">FAQ</h6>
        <h6 className="mb-3">Payment</h6>
        <h6 className="mb-3">Track Order</h6>
        </div>
        <div className="col-3">
        <Link to='/contactus'><h5 className="mb-3">Shipping & Returns</h5></Link>
...
</svg>copyright <span>Spinneys Group. All Rights Reserved</span>
      </div>
    </div>
  );
}
